...
import static com.ramkumar.earthquakeapp.EarthquakeActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    static List<Earthquake> extractJsonResponse(String baseurl) {
        ...
        try {
            ...
            JSONArray quakeFeatures = baseJSONResponse.getJSONArray("features");
            for(int i=0;i<quakeFeatures.length();i++) {
                JSONObject features = quakeFeatures.getJSONObject(i);
        ...
        Log.e(LOG_TAG,"fetchJSONResponse");
        return list;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e(LOG_TAG,"Error Rssponse Code" + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
